...
abstract class Payje_Client {

    const PRODUCTION_URL = 'https://apps-api.payje.com/api/';
    const SANDBOX_URL    = 'https://apps-api-test.payje.com/api/';
    ...
    private function get_valid_ipn_response( array $data ) {
        ...
        // If request is not POST, we return empty array since Payje does not return any extra parameter to the redirect URL
